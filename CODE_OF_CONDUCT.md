...
Tracexy project and our community a harassment-free experience for everyone,
...
managed by the Tracexy project. It also applies when an individual is officially
representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported privately to the project maintainers by opening a report through the
repository's **[Security tab](https://github.com/RockxyApp/Tracexy/security/advisories)**, which
is visible only to maintainers.
